...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link {{ request()->is('admin/users*') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">Kelola User</a>
            <a class="nav-link {{ request()->is('admin/genres*') ? 'active' : '' }}" href="{{ route('admin.genres.index') }}">Kelola Genre</a>
            <a class="nav-link {{ request()->is('admin/comics*') ? 'active' : '' }}" href="{{ route('admin.comics.index') }}">Kelola Komik</a>
            <hr>

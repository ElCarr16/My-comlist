    ...
    <div class="container mb-5 px-3">
        ...
        <section class="hero-welcome shadow-lg mb-5">
            <div class="row w-100 align-items-center m-0"> 
                    <p class="text-warning fw-bold text-uppercase mb-2" style="letter-spacing: 2px; font-size: 0.75rem;">
                        Platform Komik Modern</p>
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3">
                        @guest
                            ...
                            <a href="{{ route('login') }}" class="btn btn-orange px-lg-5">
                                Login <i class="bi bi-arrow-right ms-2"></i>
                            </a>
                        @else
                            <a href="{{ route('comics.index') }}" class="btn btn-orange px-lg-5">
                                Beranda <i class="bi bi-arrow-right ms-2"></i>
                            </a>
                        @endguest
                    </div>
                </div>
